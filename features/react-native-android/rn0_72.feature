Feature: React Native Android 0.72 Integration Tests

  Scenario: Upload a single React Native Android sourcemap using all CLI flags
    When I run bugsnag-cli with upload react-native-android --upload-api-root-url=http://localhost:9339 --api-key=1234567890ABCDEF1234567890ABCDEF --overwrite --app-manifest=features/react-native-android/fixtures/rn0_72/android/app/build/intermediates/merged_manifests/release/AndroidManifest.xml --bundle=features/react-native-android/fixtures/rn0_70/android/app/build/generated/sourcemaps/react/release/index.android.bundle.map --code-bundle-id=1.0-15 --dev --source-map=features/react-native-android/fixtures/rn0_72/android/app/build/generated/sourcemaps/react/release/index.android.bundle.map --variant=release --version-name=1.0 --version-code=1
  ...
  Scenario: Upload a single React Native Android sourcemap providing the app-manifest, bundle and source-map CLI flag
    When I run bugsnag-cli with upload react-native-android --upload-api-root-url=http://localhost:9339 --api-key=1234567890ABCDEF1234567890ABCDEF --overwrite --app-manifest=features/react-native-android/fixtures/rn0_72/android/app/build/intermediates/merged_manifests/release/AndroidManifest.xml --bundle=features/react-native-android/fixtures/rn0_70/android/app/build/generated/sourcemaps/react/release/index.android.bundle.map --source-map=features/react-native-android/fixtures/rn0_72/android/app/build/generated/sourcemaps/react/release/index.android.bundle.map
    And I wait to receive 1 sourcemaps
    Then the sourcemap is valid for the React Native Build API
    Then the sourcemaps Content-Type header is valid multipart form-data
    And the sourcemap payload field "apiKey" equals "1234567890ABCDEF1234567890ABCDEF"
