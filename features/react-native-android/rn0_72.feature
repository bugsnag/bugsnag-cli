Feature: React Native 0.72 Android Integration Tests
  ...
  Scenario: Upload a single React Native 0.72 Android sourcemap using all CLI flags
    When I run bugsnag-cli with upload react-native-android --upload-api-root-url=http://localhost:9339 --api-key=1234567890ABCDEF1234567890ABCDEF --overwrite --app-manifest=features/react-native-android/fixtures/rn0_72/android/app/build/intermediates/merged_manifests/release/AndroidManifest.xml --bundle=features/react-native-android/fixtures/rn0_72/android/app/build/generated/sourcemaps/react/release/index.android.bundle.map --dev --source-map=features/react-native-android/fixtures/rn0_72/android/app/build/generated/sourcemaps/react/release/index.android.bundle.map --variant=release --version-name=1.0 --version-code=1
