...
#ifndef SWIFT_PACKAGE_MANAGER_SWIFT_H
#define SWIFT_PACKAGE_MANAGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="swift_package_manager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC21swift_package_manager12AnotherClass")
...
SWIFT_CLASS("_TtC21swift_package_manager11AppDelegate")
...
SWIFT_CLASS("_TtC21swift_package_manager13SceneDelegate")
...
SWIFT_CLASS("_TtC21swift_package_manager14ViewController")
