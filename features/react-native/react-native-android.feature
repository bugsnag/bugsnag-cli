...
#  TODO: Reinstate tests to cover all escape hatches to ensure proper functionality and edge case handling.
  Scenario: Upload a single React Native Android sourcemap
    When I run bugsnag-cli with upload react-native-android --upload-api-root-url=http://localhost:9339 --api-key=1234567890ABCDEF1234567890ABCDEF --overwrite features/react-native/fixtures/generated/old-arch/$RN_VERSION
