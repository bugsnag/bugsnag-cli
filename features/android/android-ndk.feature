Feature: Android NDK Integration Test
  ...
  Scenario: Upload Single Android NDK Sourcemap
    When I run bugsnag-cli with upload android-ndk --upload-api-root-url=http://localhost:9339 --api-key=1234567890ABCDEF1234567890ABCDEF --overwrite --app-manifest=features/fixtures/android/app/build/intermediates/merged_manifests/release/AndroidManifest.xml --android-ndk-root=$ANDROID_NDK_ROOT features/fixtures/android/app/build/intermediates/merged_native_libs/release/out/lib/arm64-v8a/libbugsnag-ndk.so
