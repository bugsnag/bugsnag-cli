Feature: Webpack 5 js Integration Tests
  ...
  Scenario: Upload a single js sourcemap using all CLI flags
    When I run bugsnag-cli upload "js" with the following arguments:
      ...
      | --version-name                        | 2.3.4                                             |
      | --source-map                          | features/js/fixtures/js-webpack5/dist/main.js.map |
      | --bundle                              | features/js/fixtures/js-webpack5/dist/main.js     |
      | --project-root                        | features/js/fixtures/js-webpack5                  |
      | features/js/fixtures/js-webpack5/dist |                                                   |
  ...
  Scenario: Resolves the path specified as the map
    When I run bugsnag-cli upload "js" with the following arguments:
      ...
      | --bundle-url                                      | example.com                        |
      | --project-root                                    | features/js/fixtures/js-webpack5   |
      | features/js/fixtures/js-webpack5/dist/main.js.map |                                    |
    And I wait to receive 1 sourcemaps
    Then the sourcemaps are valid for the API
    Then the sourcemaps Content-Type header is valid multipart form-data
    And the sourcemap payload field "apiKey" equals "1234567890ABCDEF1234567890ABCDEF"
  ...
  Scenario: Searches in the dist folder automatically
    When I run bugsnag-cli upload "js" with the following arguments:
      ...
      | --base-url                        | example.com                        |
      | --project-root                    | features/js/fixtures/js-webpack5   |
      | features/js/fixtures/js-webpack5/ |                                    |
    And I wait to receive 1 sourcemaps
    Then the sourcemaps are valid for the API
    Then the sourcemaps Content-Type header is valid multipart form-data
    And the sourcemap payload field "apiKey" equals "1234567890ABCDEF1234567890ABCDEF"
  ...
  Scenario: Build and Upload js webpack5 sourcemaps
    ...
    When I run bugsnag-cli upload "js" with the following arguments:
      ...
      | --api-key                                 | 1234567890ABCDEF1234567890ABCDEF   |
      | --base-url                                | example.com                        |
      | features/base-fixtures/js-webpack5/dist/  |                                    |
    And I wait to receive 1 sourcemaps
    Then the sourcemaps are valid for the API
    Then the sourcemaps Content-Type header is valid multipart form-data
    And the sourcemap payload field "apiKey" equals "1234567890ABCDEF1234567890ABCDEF"
