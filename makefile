...
features/base-fixtures/rn0_69/ios:
	...
	cd $@ && xcodebuild -workspace rn0_69.xcworkspace -scheme rn0_69 -configuration Release -allowProvisioningUpdates archive
...
features/base-fixtures/rn0_70/ios:
	...
	cd $@ && bundle install
	cd $@ && bundle exec pod install --repo-update
	cd $@ && xcodebuild -workspace rn0_70.xcworkspace -scheme rn0_70 -configuration Release -allowProvisioningUpdates archive
...
features/base-fixtures/rn0_72/ios:
	...
	cd $@ && bundle install
	cd $@ && bundle exec pod install --repo-update
	cd $@ && xcodebuild -workspace rn0_72.xcworkspace -scheme rn0_72 -configuration Release -allowProvisioningUpdates archive
