...
func TestBuildFileList(t *testing.T) {
	...
	assert.Equal(t, results, []string{"../testdata/android/android-mapping.txt", "../../README.md"}, "The files should be the same")
...
func TestFilePathWalkDir(t *testing.T) {
	...
	assert.Equal(t, results, []string{"../testdata/android/android-mapping.txt"}, "This should return a file")
}
